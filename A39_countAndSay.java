public class A39_countAndSay {
    ...
    public static void main(String[] args) {
        A39_countAndSay solution = new A39_countAndSay();
        int n = 4;
        System.out.println("The " + n + "th term in the 'Count and Say' sequence is: " + A39_countAndSay.CountAndSay(n));
    }
}
